object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(155); 
  // VALUES are immutable constants. You can't change them once defined.
  val hello: String = "This is value, which is immutable!";System.out.println("""hello  : String = """ + $show(hello ));$skip(18); 
  ...
  var helloThere: String = hello;System.out.println("""helloThere  : String = """ + $show(helloThere ));$skip(49); 
  helloThere = hello + " There! This is mutable";$skip(22); 
  ...
  val newImmutable = immutableHelloThere + "I know";System.out.println("""newImmutable  : String = """ + $show(newImmutable ));$skip(24); 
  println(newImmutable);$skip(51); 
  
  // Some other types
  val numberOne : Int = 1;System.out.println("""numberOne  : Int = """ + $show(numberOne ));$skip(20); 
  val numberTwo = 2;System.out.println("""numberTwo  : Int = """ + $show(numberTwo ));$skip(29); 
  ...
  val smallNumber : Byte = 127;System.out.println("""smallNumber  : Byte = """ + $show(smallNumber ));$skip(46); 
  
  println(f"Double the value ${pi*2}%.3f");$skip(147); 
  ...
  println(s"The s prefix isn't limited to variables; I can include any expression. Like ${1+2}");$skip(61); 
  println(f"This is all a string $numberOne $numberTwo%04d");$skip(79); 
  
  println("This is also a string by concatination" + numberOne + numberTwo);$skip(47); 
  println(f"Add numbers ${numberTwo%02d / 2}");$skip(26); 
  
  val string1 = "same";System.out.println("""string1  : String = """ + $show(string1 ));$skip(23); 
  val string2 = "same";System.out.println("""string2  : String = """ + $show(string2 ));$skip(35); 
  val compare = string1 == string2;System.out.println("""compare  : Boolean = """ + $show(compare ));$skip(22); 
  
  println(compare);$skip(122); 
