object LearningScala4 {
 ...
 println("Key: " + picardsShip._1)                //> Key: Picard
 println("Value: " + picardsShip._2)              //> Value: Enterprise-D
...
val iHateTwo = numberList.filter(x => x != 2)     //> iHateTwo  : List[Int] = List(1, 3, 4, 5)
for (each <- iHateTwo) println(each)              //> 1
                                                  //| 3
                                                  //| 4
                                                  //| 5
...
val n = util.Try(shipMap("Enterprise")) getOrElse "Unknown"
                                                  //> n  : String = Unknown
println(n)                                        //> Unknown
